...
exports.create = async (req, res, nex) => {
    try {
        const getRecord = await db.findData({
            req: {},
            model: models.ImageGalleryCategory,
            query: {
                name: req.body.name,
            },
        });
...
exports.getById = async (req, res, next) => {
    try {
        const { id } = req.params;
        const getRecordById = await db.findById(id, models.ImageGalleryCategory);
...
exports.remove = async (req, res, next) => {
    try {
        ...
        const removeRecord = await db.delete(id, models.ImageGalleryCategory);
        return res.status(200).json({
            success: true,
            status: 200,
            data: removeRecord,
